...
public class EmotiomComplateFragment extends EmotionBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.emotion_fragment_complate_emotion, container, false);
        initView(rootView);
        initListener();
        return rootView;
    }
    ...
    protected void initView(View rootView) {
        ...
        //获取map的类型
        emotion_map_type = args.getInt(EmotionFragmentFactory.EMOTION_MAP_TYPE);
        initEmotion();
    }
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = EmotionDisplayUtils.getScreenWidthPixels(getActivity());
        // item的间距
        int spacing = EmotionDisplayUtils.dp2px(getActivity(), 12);
        // 动态计算item的宽度和高度
