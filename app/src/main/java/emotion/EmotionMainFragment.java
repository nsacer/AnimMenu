...
public class EmotionMainFragment extends EmotionBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.emotion_fragment_main_emotion, container, false);
    ...
    protected void initView(View rootView) {
        ...
        if (isHidenBarEditTextAndBtn) {//隐藏
            ...
            rl_editbar_bg.setBackgroundResource(R.drawable.emotion_shape_bg_reply_edittext);
        }
    }
    ...
    protected void initDatas() {
        ...
        //记录底部默认选中第一个
        CurrentPosition = 0;
        EmotionSharedPreferencedUtils.setInteger(getActivity(), CURRENT_POSITION_FLAG, CurrentPosition);
        ...
        horizontalRecyclerviewAdapter.setOnClickItemListener(new HorizontalRecyclerviewAdapter.OnClickItemListener() {
            @Override
            public void onItemClick(View view, int position, List<EmotionImageModel> datas) {
                //获取先前被点击tab
                int oldPosition = EmotionSharedPreferencedUtils.getInteger(getActivity(), CURRENT_POSITION_FLAG, 0);
                //修改背景颜色的标记
            ...
            @Override
            public void onItemLongClick(View view, int position, List<EmotionImageModel> datas) {
            }
        });
    ...
    private void replaceFragment() {
        //创建fragment的工厂类
        EmotionFragmentFactory factory = EmotionFragmentFactory.getSingleFactoryInstance();
        //创建修改实例
        ...
        for (int i = 0; i < 7; i++) {
            ...
            EmotionFragmentTv fg = EmotionFragmentTv.newInstance(EmotionFragmentTv.class, b);
            fragments.add(fg);
        }
