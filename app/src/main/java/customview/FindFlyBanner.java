...
import transformer.ScalePagerTransformer;
...
public class FindFlyBanner extends RelativeLayout {
    ...
    public FindFlyBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FindFlyBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setLayout(Context context) {
        ...
        mViewPager.setPageMargin(getResources().getDimensionPixelOffset(R.dimen.dp8));
        mViewPager.setPageTransformer(true, new ScalePagerTransformer());
        int dp32 = getResources().getDimensionPixelOffset(R.dimen.dp32);
        LayoutParams vp = new LayoutParams(RMP, RMP);
        vp.setMargins(dp32, 0, dp32, 0);
    ...
    public void setViewPagerOffscreenPageLimit(int size) {
