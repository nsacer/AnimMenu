...
import listener.listener.RemoveItemClickListener;

/**
 * Created by zpf on 2017/2/22.
 */

public class RecyclerViewItemDelete extends RecyclerView {
    ...
    public RecyclerViewItemDelete(Context context) {
        this(context, null);
    }

    public RecyclerViewItemDelete(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewItemDelete(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    RecyclerRemoveItemHolder viewHolder = (RecyclerRemoveItemHolder) getChildViewHolder(view);

                    mItemLayout = viewHolder.layoutInner;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (ImageView) mItemLayout.findViewById(R.id.iv_delete_rdi);
    ...
    public void setOnItemClickListener(RemoveItemClickListener listener) {
        mListener = listener;
    }
}
